...
const artists = [
  {
    name: 'Gentrit Mrasoraj & DJ',
    date: 'July 4, 2025',
    image: '/images/artists/gentrit-dj.png',
    tag: 'Grand Opening',
  },
  {
    name: 'Bay T',
    date: 'August 6, 2025',
    image: '/images/artists/bay-t.png',
    tag: 'Live Performance',
  },
  {
    name: 'Alberie Hadergjonaj',
    date: 'August 9, 2025',
    image: '/images/artists/alberije.png',
    tag: 'Singer',
  },
  {
    name: 'Ramadan Krasniqi - Dani',
    date: 'August 14, 2025',
    image: '/images/artists/ramadan-dani.png',
    tag: 'Live Performance',
  },
];

export function LastYearArtists() {
  return (
    <section id="last-year-artists" className="relative py-20 md:py-32 lg:py-44 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 md:px-6 lg:px-16">
        <SectionTitle
          overline="Last Season"
          title="Last Year's DJ's & Singers"
          subtitle="The artists who made our first summer unforgettable."
        />
                ...
                >
                  ...
                  <div className={`flex-1 md:py-8 ${isLeft ? 'md:pl-8' : 'md:pr-8 md:text-right'}`}>
                    ...
                    <div className={`mt-4 md:mt-6 flex items-center gap-3 ${isLeft ? 'md:justify-end' : ''}`}>
                      ...
                      <span className="text-[10px] md:text-xs tracking-[0.3em] uppercase text-gold/60 font-body font-light">{artist.tag}</span>
                    </div>
                  </div>
                </motion.div>
              );
